        ...
        try {
            ...
            if (data.tasks && data.tasks.length > 0) {
                ...
                setCurrentPart({
                    ...
                    task1_type: task.task1_type || null,
                    task2_type: task.task2_type || null,
                    title: task.title || '',
                    instructions: task.instructions || '',
                    sample_essay: task.sample_essay || '',
            ...
            if (response.ok) {
                ...
                if (currentPart.part_number === 1 && testData.tasks && testData.tasks.length > 1) {
                    ...
                    setCurrentPart({
                        ...
                        task1_type: task2.task1_type || null,
                        task2_type: task2.task2_type || null,
                        title: task2.title || '',
                        instructions: task2.instructions,
                        sample_essay: task2.sample_essay || '',
