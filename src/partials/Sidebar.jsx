          ...
          <NavLink end to="/" className="block mx-auto">
            <div className="flex justify-center items-center w-full">
              <img
                ...
                width={150}
                height={150}
                className="sidebar-logo filter-none dark:drop-shadow-[-2px_-1px_5px_rgba(255,255,255,0.8)]"
              />
            </div>
          </NavLink>
                    ...
                    <React.Fragment>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg
                              ...
                              viewBox="0 0 24 24"
                            >
                              <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM9 13h2v-2H9v2zm0 3h2v-2H9v2zm0 3h2v-2H9v2zm6-6h-2v2h2v-2zm0 3h-2v2h2v-2zm0 3h-2v2h2v-2z" />
                            </svg>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/manage_speaking_topic">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Quản Lý Speaking
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/manage_forecast">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Quản Lý Forecast
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/manage_part_titles">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/create_listening_test">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Tạo Bài Thi Nghe
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/create_writing_test">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Tạo Bài Thi Viết
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/create_reading_test">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Tạo Bài Thi Đọc
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/create_speaking_test">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Tạo Bài Thi Nói
                              </span>
                            </NavLink>
                    ...
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/pending-transactions">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Duyệt giao dịch
                              </span>
                            </NavLink>
        ...
        <div className="pt-3 hidden lg:inline-flex 2xl:hidden justify-end mt-auto">
          <div className="w-12 pl-4 pr-3 py-2">
            <button className="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              <span className="sr-only">Mở rộng / thu gọn thanh bên</span>
